...
export function validarVencimiento(vencimiento) {
...
export function validarDificultad(opcion) {
...
export function validarEstado(opcion) {
...
export function validarSiNo(opcion) {
...
export function validarID(listaDeTareas, idBuscado) {
...
export function tareasVencidas(listaTareas, hoy) {
    const vencidas = listaTareas.filter(tarea => {
        ...
        if (fechaVenc === null)
            return false; // sin fecha → no se considera vencida
