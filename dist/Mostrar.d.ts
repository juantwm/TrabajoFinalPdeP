...
export declare function mostrarTareas(listaTareas: interfazTarea[], opcion: number, filtroEspecifico: string): interfazTarea[];
export declare function ordenarTareasFecha(listaDeTareas: interfazTarea[]): interfazTarea[];
export declare function mostrarDetalles(listaDeTareas: interfazTarea[]): interfazTarea[];
